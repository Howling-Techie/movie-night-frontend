        ...
        <nav className="bg-gray-950 text-white p-4 flex justify-between items-center">
            ...
            <div>
                {user ? (<Menu as="div" className="relative inline-block text-left">
                        ...
                        >
                            <Menu.Items
                                className="absolute right-0 mt-2 w-40 origin-top-right divide-y rounded-md bg-surface shadow-lg ring-1 ring-black/5 focus:outline-none">
                                    ...
                                    <Menu.Item>
                                        {({active}) => (
                                            <button onClick={() => navigate("/profile")}
                                                    className={`${
                                                        active ? 'bg-primary' : ''
                                                    } group flex text-primary-text w-full items-center rounded-md px-2 py-2 text-sm`}
                                            >Profile
                                            </button>
                                        )}
                                    </Menu.Item>
